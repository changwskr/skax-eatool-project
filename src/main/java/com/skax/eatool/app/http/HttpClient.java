package com.skax.eatool.app.http;
...
public class HttpClient {
    ...
    private WebClient.RequestBodySpec createRequestSpec(HttpMethod method, String url, HttpHeaders headers,
    ...
    private void addBody(WebClient.RequestBodySpec requestSpec, HttpMethod method, Object body)
    ...
    public <T> T request(HttpMethod method, String url, HttpHeaders headers, Map<String, Object> queryParams,
            Object body,
        ...
        try {
            ...
            if (responseType instanceof Class<?>) {
                ...
                throw new IllegalArgumentException(
                        "Unsupported response type. Must be Class<?> or ParameterizedTypeReference<?>.");
            }
    ...
    public <T> T get(String url, HttpHeaders headers, Map<String, Object> queryParams, Object responseType) {
        return executeRequest(HttpMethod.GET, url, headers, queryParams, null, responseType,
    ...
    public <T> T put(String url, HttpHeaders headers, Map<String, Object> queryParams, Object body, Object responseType,
            HttpOptions options) {
        return executeRequest(HttpMethod.PUT, url, headers, queryParams, body, responseType, options);
    }

    public <T> T delete(String url, HttpHeaders headers, Map<String, Object> queryParams, Object body,
            Object responseType, HttpOptions options) {
    ...
    private static org.springframework.util.MultiValueMap<String, String> convertToMultiValueMap(
            Map<String, Object> queryParams) {
    ...
    private <T> Mono<T> handleError(WebClientResponseException e, Object responseType) {
        try {
            ...
            if (responseType instanceof ParameterizedTypeReference<?>) {
                return Mono.just(objectMapper.readValue(responseBody, objectMapper.getTypeFactory()
                        .constructType(((ParameterizedTypeReference<?>) responseType).getType())));

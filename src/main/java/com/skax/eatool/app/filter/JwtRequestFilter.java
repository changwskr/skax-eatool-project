package com.skax.eatool.app.filter;
...
import com.skax.eatool.app.dto.ApiResponse;
import com.skax.eatool.app.exception.CustomException;
import com.skax.eatool.app.exception.ErrorCode;
import com.skax.eatool.app.util.HttpResponseUtil;
import com.skax.eatool.app.util.JwtUtil;

import com.skax.eatool.user.service.CustomUserDetailService;
import com.skax.eatool.biz.token.service.TokenService2;
 ...
 * 2. {@link JwtUtil#validateTokenAndExtractUID(String)}을 사용하여 토큰 및 UID(사용자
 * 식별자)를 추출합니다.
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (token != null) {
            ...
            try {
                ...
                uid = tokenService2.validateTokenAndExtractUserId(token);
                ...
                if (uid != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    try {
                        ...
                        if (userDetails != null) {
                            ...
                            log.debug(
                                    "########## JWT FILTER SUCCESS - Security Context 인증 설정 완료. userId: {}, method: {}, path: {}",
                                    uid, request.getMethod(), requestPath);
                        } else {
                        ...
                        log.error(
                                "JWT FILTER ERROR - 사용자 조회 실패. userId: '{}', method: {}, path: {}, errorCode: {}, message: {}",

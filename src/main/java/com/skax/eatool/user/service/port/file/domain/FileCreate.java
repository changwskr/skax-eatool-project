...
import com.skax.eatool.user.util.DateUtil;
import com.skax.eatool.user.service.port.file.service.UploadPolicies;
    ...
    private static void validateFileByPolicy(MultipartFile file, UploadPolicies.UploadPolicy policy) {
        ...
        if (file.getSize() > policy.getMaxFileSize()) {
            throw new IllegalArgumentException(
                    "파일 크기가 최대 허용 크기를 초과합니다. (" + policy.getMaxFileSize() / 1024 / 1024 + " MB)");
        }

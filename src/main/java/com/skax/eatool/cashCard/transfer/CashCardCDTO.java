...
public class CashCardCDTO extends DTO {
    ...
    @Override
    public DTO clone() {
        CashCardCDTO cloned = new CashCardCDTO();
        ...
        cloned.registerType = this.registerType;
        cloned.primaryCurrency = this.primaryCurrency;
        cloned.secondaryCurrency = this.secondaryCurrency;
        cloned.tenaryCurrency = this.tenaryCurrency;
        cloned.primaryBalance = this.primaryBalance;
        cloned.secondaryBalance = this.secondaryBalance;
        cloned.tenaryBalance = this.tenaryBalance;
        cloned.recordCount = this.recordCount;
        cloned.targetAccountNo = this.targetAccountNo;
        cloned.targetCIFName = this.targetCIFName;
